"""
Django settings for test_komatzu_47496 project.
...
ROOT_URLCONF = 'test_komatzu_47496.urls'
...
WSGI_APPLICATION = 'test_komatzu_47496.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_komatzu_47496 API",
    "DESCRIPTION": "API documentation for test_komatzu_47496 App",
    "VERSION": "v1",
}
